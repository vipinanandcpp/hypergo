...
class AzureLogAnalyticsMonitorStorage(Monitor):
    def __init__(self, metadata) -> None:
        ...
        # @TODO: move to env
        self.workspace_id = os.environ.get("WORKSPACE_ID", "b304b831-4fad-458b-b710-87428f724e54")
    ...
    def _post_data(self, body):
        ...
        signature = self._build_signature(workspace_id=self.workspace_id, shared_key=self.shared_key, date=rfc1123date,
                                          content_length=content_length, method=method, content_type=content_type, resource=resource)
